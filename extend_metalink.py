# this file consists of all the IRIs as well as the extension of Metalink
...
my_encoding_equivalence = "https://krr.triply.cc/krr/metalink/def/isEquivalentByEncodingTo" # a relation
